        ...
        <div>
          <form onSubmit={this.handleSubmitManual}>
            <div >
              ...
              <div className='block'>
                <label >Latitude(Positive numbers for North, negative numbers for South):</label>
                <input className="manualInput" type="number" placeholder="Rack Latitude" onChange={this.handleLatitude} value={this.state.latitude} />
              </div>
              <div className='block'>

                <label>Longitude (Positive numbers for East, negative numbers for West):</label>
                <input className="manualInput" type="number" placeholder="Rack Longitude" onChange={this.handleLongitude} value={this.state.longitude} />
              </div>
